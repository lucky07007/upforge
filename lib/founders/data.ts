...
export const FOUNDERS: Founder[] = [
  ...
  funding: "$490M+",
  founded: "2023",
  imageUrl: "https://images.upforge.org/Magazine/brendan-foody-mercor-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/brendan-foody-mercor-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/brendan-foody-mercor-founder-news.webp",
  verified: true,
  ...
  funding: "$2.5B+",
  founded: "2017",
  imageUrl: "https://images.upforge.org/Magazine/rodrigo-liang-sambanova-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/rodrigo-liang-sambanova-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/rodrigo-liang-sambanova-founder-news.webp",
  verified: true,
  ufrnCode: "UF-2026-US-XXXXX",
  ...
  funding: "$500M+",
  founded: "2022",
  imageUrl: "https://images.upforge.org/Magazine/aravind-srinivas-perplexity-ai-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/aravind-srinivas-perplexity-ai-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/aravind-srinivas-perplexity-ai-founder-news.webp",
  verified: true,
  ufrnCode: "UF-2026-US-XXXXX",
  ...
  
{
  ...
  funding: "$130M+",
  founded: "2025",
  imageUrl: "https://images.upforge.org/Magazine/mukund-jha-emergent-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/mukund-jha-emergent-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/mukund-jha-emergent-founder-news.webp",
  verified: true,
  ...
  
  {
    ...
    funding: "$100M+",
    founded: "2022",
    imageUrl: "https://images.upforge.org/Magazine/michael-truell-cursor-founder-card.webp",
    cardImage: "https://images.upforge.org/Magazine/michael-truell-cursor-founder-card.webp",
    newsImage: "https://images.upforge.org/Magazine/michael-truell-cursor-founder-news.webp",
    verified: true,
    ufrnCode: "UF-2026-US-XXXXX",
...

{
  ...
  funding: "$1B+",
  founded: "2022",
  imageUrl: "https://images.upforge.org/Magazine/gavin-uberti-etched-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/gavin-uberti-etched-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/gavin-uberti-etched-founder-news.webp",
  verified: true,
...

{
  ...
  funding: "$3.7B+",
  founded: "2023",
  imageUrl: "https://images.upforge.org/Magazine/yang-zhilin-moonshot-ai-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/yang-zhilin-moonshot-ai-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/yang-zhilin-moonshot-ai-founder-news.webp",
  verified: true,
...

{
  ...
  funding: "$30M+",
  founded: "2026",
  imageUrl: "https://images.upforge.org/Magazine/bhavin-turakhia-neo-founder-card.webp",
  cardImage: "https://images.upforge.org/Magazine/bhavin-turakhia-neo-founder-card.webp",
  newsImage: "https://images.upforge.org/Magazine/bhavin-turakhia-neo-founder-news.webp",
  verified: true,
...
export function getCountryFlag(countryOrCode?: string): string {
...
export function getAllCountries(): { name: string; slug: string; code: string; count: number; flag: string }[] {
  const map = new Map<string, { name: string; slug: string; code: string; count: number; flag: string }>()
  FOUNDERS.forEach(f => {
    const cName = f.country || "United States"
    const cSlug = getCountrySlug(cName)
    const cCode = f.countryCode || "US"
...
export function getFoundersByCountry(countrySlug: string): Founder[] {
  if (!countrySlug || countrySlug === "all") return FOUNDERS
  return FOUNDERS.filter(f => getCountrySlug(f.country) === countrySlug || f.countryCode?.toLowerCase() === countrySlug)
}
